...
class IndexedStackTransitionBuilder extends StatefulWidget {
  /// Creates an [IndexedStackTransitionBuilder].
  const IndexedStackTransitionBuilder({
    required this.index,
  ...
  _IndexedStackTransitionBuilderState createState() =>
      _IndexedStackTransitionBuilderState();
}

class _IndexedStackTransitionBuilderState
    extends State<IndexedStackTransitionBuilder> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(IndexedStackTransitionBuilder oldWidget) {
  ...
  Widget build(BuildContext context) => Stack(
        ...
        fit: widget.sizing ?? StackFit.loose,
